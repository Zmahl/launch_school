...
function Human() {
  //Calls the Player function with given parameter whenever Human is called
  Player.call(this, Square.HUMAN_MARKER);
}
//Object.create will return the OBJECT of the given argument/call
//Set Humans prototype to the player; Object.create(Player) === Human extends Player
//Adds Player to the Human prototype change ==> access to Player.getMarker
Human.prototype = Object.create(Player.prototype);
//Constructor is the value referenced when 'new' is called
//This will set the 'new' operator to reference Human()
Human.prototype.constructor = Human;


function Computer() {
  //(Super Class).call(currentScope, parameters...)
  //This will give the object type "Human" AND connect returned object to desired scope
  Player.call(this, Square.COMPUTER_MARKER);
}

Computer.prototype = Object.create(Player.prototype);
//This now references function Computerr, which calls Player w/ COMPUTER MARKER
//constructor() === Computer.prototype.constructor = Computer;
...
TTTGame.prototype.isWinner = function s(player) {
